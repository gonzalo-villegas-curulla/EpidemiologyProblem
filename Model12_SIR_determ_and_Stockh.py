...
visual_AllGroups      = 1 # See S-I-R (True), only (I) if False.
...
for IdxSimul in range(NumSimuls):
    ...
    X_t, Sinf[IdxSimul] = FirstReac_SIR(G, beta, alpha, T, adj_matrix, edge_lengths)
    X_array.append(X_t)
